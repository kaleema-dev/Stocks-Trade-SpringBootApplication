...
import com.kabi.code.stocktrading.service.AdminService;
...
public class AdminController
{
    ...
    {
        System.out.println("Verifying admin user details 1");
        if (!this.sessionMgmtUtils.doesSessionExist(request)) 
        {
            System.out.println("Verifying admin user details 2");
            logger.info("Admin page");
            ModelAndView mv = new ModelAndView("login-form");
            mv.addObject("user", new User());
            mv.addObject("errorMessage", "You are unauthorized to view this page");
        ...
        System.out.println("Verifying admin user details 3");
